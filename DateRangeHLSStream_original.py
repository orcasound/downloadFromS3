...
from orca_hls_utils import datetime_utils, s3_utils, scraper
...
class DateRangeHLSStream:
    ...
    #    stream_url = 'https://us-west-2.console.aws.amazon.com/s3/buckets/audio-orcasound-net/rpi_orcasound_lab/hls/1736064019/live.m3u8'
